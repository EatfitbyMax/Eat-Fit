        ...
        <View style={[styles.section, {marginTop: 20}]}>
          <View style={styles.premiumSection}>
            <View style={styles.premiumHeader}>
              <Text style={styles.premiumTitle}>👑 Passez au Premium</Text>
              <Text style={styles.premiumSubtitle}>
                Débloquez tout le potentiel d'EatFitByMax
              </Text>
            </View>

            <View style={styles.subscriptionPlans}>
              {/* Plan Bronze */}
              <TouchableOpacity style={[styles.planCard, styles.bronzePlan]}>
                ...
                <View style={styles.planFeatures}>
                  ...
                  <Text style={styles.planFeature}>✓ 1 programme nutrition</Text>
                  <Text style={styles.planFeature}>✓ Suivi hebdomadaire</Text>
                </View>
              </TouchableOpacity>

              {/* Plan Argent */}
              <TouchableOpacity style={[styles.planCard, styles.silverPlan]}>
                <View style={styles.planHeader}>
                  <Text style={styles.planIcon}>🥈</Text>
                  <View style={styles.planInfo}>
                ...
                <View style={styles.planFeatures}>
                  ...
                  <Text style={styles.planFeature}>✓ Programmes personnalisés</Text>
              ...
              {/* Plan Or */}
              <TouchableOpacity style={[styles.planCard, styles.goldPlan]}>
                <View style={styles.planHeader}>
                  <Text style={styles.planIcon}>🥇</Text>
                  <View style={styles.planInfo}>
            ...
            <TouchableOpacity style={styles.subscribeMainButton}>
              <Text style={styles.subscribeMainButtonText}>🚀 Commencer mon essai gratuit</Text>
              <Text style={styles.subscribeMainButtonSubtext}>7 jours gratuits, puis 39,99€/mois</Text>
            </TouchableOpacity>
